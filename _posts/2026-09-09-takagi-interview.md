...
独立研究者 高木志郎さんインタビュー： Atlas of Judgment と科学の暗黙知
...
本記事はZoomでのインタビューをもとに、発言の趣旨を保ちながら構成したものですす。図版出典：高木志郎「Atlas of Judgment」（サイト掲載条件に基づきCC BY 4.0で利用）。 [利用条件](https://atlas-of-judgment.pages.dev/resources.html)
